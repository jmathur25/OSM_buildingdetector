...
def deg_to_tilexy_matrix(lat_deg, lon_deg, zoom, center_tile_xoffset, center_tile_yoffset):
...
def tilexy_to_deg_matrix(xtile, ytile, zoom, x, y, center_tile_xoffset, center_tile_yoffset):
