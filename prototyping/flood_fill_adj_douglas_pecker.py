...
def run_all(image, click_x, click_y, threshold_passed=None):
    ...
    flood_image, x_max, y_max, x_min, y_min = flood_fill(image, click_x, click_y, target_color, replace_color)
    cv2.imwrite('floodFill.PNG', flood_image)
    total_edge_list, edge_image = flood_fill_edge_finder(flood_image, x_max, y_max, x_min, y_min, replace_color, np.array([0, 0, 0]))
